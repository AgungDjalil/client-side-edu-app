...
export function CardComp() {
    const text = "Track work across the enterprise through an open, collaborative platform. Link issues across Jira and ingest data from other software development tools, so your IT support and operations teams have richer contextual information to rapidly respond to requests, incidents, and changes."
    ...
    return (
        <div className="flex flex-col h-max bg-white rounded-lg mb-4">
            <div className="flex h-max ms-2 mt-2 gap-2">
                ...
                <NavLink className="self-center underline" to={"/"}>Matematika</NavLink>
            </div>
