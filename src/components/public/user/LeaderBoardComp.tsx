...
export function LeaderBoardComp() {
    const nama = "Tonosfsdssdfsf sfadsfdfsfdsf"
    
    return (
        <div className="flex flex-col bg-white rounded-lg lg:mt-4 lg:mx-2 lg:w-max h-max">
            ...
            <div className="flex justify-between mx-2 mb-4">
                <div className="flex">
                    <svg className="self-center h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="lg:ms-7">poin 1000</p>
            </div>
        </div>
    )
}